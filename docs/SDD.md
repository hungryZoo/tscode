...
- focused panel
- hover target
- quick panel state for quick open, workspace search, document symbols, workspace symbols, go-to-definition candidates, references, problems, source control, and command palette
