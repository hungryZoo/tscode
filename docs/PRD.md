...
- As a developer, I can undo and redo edits, paste text, repeat search matches, close clean tabs immediately, choose whether to save, discard, or cancel when closing a dirty tab, and reopen the most recently closed editor when I closed the wrong tab.
