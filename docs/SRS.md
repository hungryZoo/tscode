...
- Modify a tracked Git file, open Source Control, confirm changed-file and hunk rows appear, confirm stage/unstage rows update `git diff --cached`, and confirm the hunk row opens the file at the changed line.
