...
- Source Control from the command palette lists Git changed files and parsed diff hunks, supports fuzzy filtering, can stage/unstage selected paths or all changes, and jumps from a hunk row to the changed source line.
