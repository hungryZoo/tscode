...
The prerelease includes a real filesystem explorer, editable tabbed code buffers with line numbers and syntax highlighting, mouse hover/click/wheel interactions, and a bottom integrated terminal backed by a real PTY shell. Passing a file path opens its parent folder as the workspace and opens that file in the editor.
...
```sh
curl -fsSL https://raw.githubusercontent.com/hungryZoo/tscode/main/install.sh | TSCODE_VERSION=v0.1.0-pre.46 sh
```
